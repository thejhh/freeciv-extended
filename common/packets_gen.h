...
struct packet_endgame_report_old {
  int category_num;
  char category_name[32][MAX_LEN_NAME];
  int player_num;
  int player_id[MAX_NUM_PLAYERS];
  int score[MAX_NUM_PLAYERS];
  int category_score[32][MAX_NUM_PLAYERS];
};
...
struct packet_endgame_report_new {
  int category_num;
  char category_name[32][MAX_LEN_NAME];
  int player_num;
};
...
struct packet_endgame_report_old *receive_packet_endgame_report_old(struct connection *pc, enum packet_type type);
int send_packet_endgame_report_old(struct connection *pc, const struct packet_endgame_report_old *packet);
void lsend_packet_endgame_report_old(struct conn_list *dest, const struct packet_endgame_report_old *packet);
...
struct packet_endgame_report_new *receive_packet_endgame_report_new(struct connection *pc, enum packet_type type);
int send_packet_endgame_report_new(struct connection *pc, const struct packet_endgame_report_new *packet);
void lsend_packet_endgame_report_new(struct conn_list *dest, const struct packet_endgame_report_new *packet);
